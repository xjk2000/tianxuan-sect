...
**归档前必须生成宗门记载，存入宗门记忆库，供后续会话跨会话读取。**

宗主在归档前输出以下 XML，然后调用藏经阁长老存档：

```xml
<宗门记载>
  <任务需求>[从任务总览.md 提取任务核心需求]</任务需求>
  <调查发现>[各堂在执行过程中发现的关键技术信息和项目现状]</调查发现>
  <学到知识>[本次任务最有价值的技术取得和经验教训]</学到知识>
  <完成工作>
    藏经阁：[完成的调研内容]
    阵堂：[完成的后端工作]
    器堂：[完成的前端工作]
  ...
  <下一步骤>[本任务开启的新话题或后续改进建议]</下一步骤>
  <备注>[被放弃的方案、潜在风险、特殊说明等]</备注>
</宗门记载>
```

```
@藏经阁长老 请将以上宗门记载存入 天玄宗/宗门记载/SUMMARIES.md
```
